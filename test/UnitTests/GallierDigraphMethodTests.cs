...
namespace UnitTests
{
    public class GallierDigraphMethodTests
    {
        ...
        public void First()
        {
            ...
            Grammar.First(Symbol.V("E")).ShouldSetEqual(Symbol.Ts(Sym.LPARAN, Sym.MINUS, Sym.ID));
            Grammar.First(Symbol.V("T")).ShouldSetEqual(Symbol.Ts(Sym.LPARAN, Sym.MINUS, Sym.ID));
            Grammar.First(Symbol.V("F")).ShouldSetEqual(Symbol.Ts(Sym.LPARAN, Sym.MINUS, Sym.ID));
