namespace UnitTests.Lexers
{
    ...
    internal class CalcLexer : ILexer<Sym>
    {
        ...
        Token<Sym> Accept_2()
        { return new Token<Sym>(Sym.LPARAN); }

        Token<Sym> Accept_3()
        { return new Token<Sym>(Sym.RPARAN); }

        Token<Sym> Accept_4()
        { return new Token<Sym>(Sym.PLUS); }

        Token<Sym> Accept_5()
        { return new Token<Sym>(Sym.MINUS); }
